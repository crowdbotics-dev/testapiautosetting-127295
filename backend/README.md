...
## Project Structure
    ...
    ├── testapiautosetting_127295  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127295`
...
2. Clone this repo and `cd testapiautosetting_127295`
